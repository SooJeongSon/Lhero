...
HWND g_hWnd;
LPSTR g_lpszClass = (LPSTR)TEXT("Loop Hero : 손수정 2D 포트폴리오");
MainGame g_mainGame;
POINT g_ptMouse;
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(g_lpszClass, g_lpszClass, WS_OVERLAPPEDWINDOW, WIN_STARTX, WIN_STARTY, WINSIZE_WIDTH, WINSIZE_HEIGHT, NULL, NULL, g_hInstance, NULL);
